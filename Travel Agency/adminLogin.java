...
public class adminLogin extends JFrame implements ActionListener{
    ...
    adminLogin() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("Images/Icon.png"));
        ...
        if(ae.getSource()==btn1){
            ...
            if (textField1.isEmpty() || textField2.isEmpty()) {
                ...
                try {
                    ...
                    BufferedReader reader = new BufferedReader(new FileReader("Datas/admin_data.txt"));
                    ...
                    for (int i = 0; i <= totalLines; i++) {
                        ...
                        if (line.equals(userNameS)) {
                            String line2 = Files.readAllLines(Paths.get("Datas/admin_data.txt")).get((i + 1));
